...
class TestProxy(unittest.TestCase):
    ...
    def exec_time(self, url, keep=0):
        ...
        return exectime
http://www.umich.edu/~chemh215/W09HTML/SSG4/ssg6/html/Website/DREAMWEAVERPGS/first.html, ,'
    ...
    def test_3clear_proxy(self):
        ...
        time.sleep(float(self.proxyTimeout))http://www.umich.edu/~chemh215/W09HTML/SSG4/ssg6/html/Website/DREAMWEAVERPGS/first.html'
        self.assertGreater(self.exec_time(url), 5)
